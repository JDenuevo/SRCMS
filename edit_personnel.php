...
<title>Admin Update Record | SR&CMS</title>
    ...
    <input type="hidden" name="per_id" value="<?= $uquery['per_id']  ?>">
        <div class = "container">          
            <div class="bg-form p-4">
                ...
                <p class = "text-center text-muted lead">Update a Professor's Record</p>
                ...
                <div class="row row-cols-4"> 
                    ...
                    <div class = "col-lg-3 col-md-6 col-sm-12">
                        ...
                        <input type="date" name="per_date_of_birth" class="form-control" placeholder="Data of Birth" value="<?= $uquery['per_date_of_birth']  ?>" required>
                    </div>
                    <div class = "col-lg-3 col-md-6 col-sm-12">
            ...
            <div class="bg-form p-4">
                ...
                <div class="row row-cols-3">
                    <div class = "col-lg-4 col-md-4 col-sm-12">
                        <label>School</label>          
                        <input type="text" name="ms_school" class="form-control" placeholder="School" value="<?= $uquery['ms_school']  ?>">
                    </div>   
                    <div class = "col-lg-4 col-md-4 col-sm-12">
                        <label>Year: YYYY</label> 
                        <input type="text" name="ms_year" class="form-control" placeholder="Year: YYYY" value="<?= $uquery['ms_year']  ?>">
                    </div>
                    <div class = "col-lg-4 col-md-4 col-sm-12">
                        <label>Masteral's Degree</label> 
                        <input type="text" name="ms_name" class="form-control" placeholder="Masteral's Degree" value="<?= $uquery['ms_name']  ?>">
                    </div> 
                </div>
                <br>
                <div class="row row-cols-3">
                <div class = "col-lg-4 col-md-4 col-sm-12">
                        <label>School</label>   
                        <input type="text" name="dr_school" class="form-control" placeholder="School" value="<?= $uquery['dr_school']  ?>">
                    </div>
                    <div class = "col-lg-4 col-md-4 col-sm-12">
                        <label>Year: YYYY</label> 
                        <input type="text" name="dr_year" class="form-control" placeholder="Year: YYYY" value="<?= $uquery['dr_year']  ?>">
                    </div>
                    <div class = "col-lg-4 col-md-4 col-sm-12">
                        <label>Doctorate's Degree</label>  
                        <input type="text" name="dr_name" class="form-control" placeholder="Doctorate Degree" value="<?= $uquery['dr_name']  ?>">
                    </div>
                </div> <br>
                <button class = "btn btn-success btn-lg" id = "btnadd" type="submit" name="update">
