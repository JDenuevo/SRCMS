...
<title>Admin Find Positions | SR&CMS</title>
    ...
    <div id="mid-search">
      <form method="GET">
        <label>Search Positions <label>
          <input type="text" name="name" placeholder="Search for Positions" value="<?php if(isset($_GET['name'])){echo $_GET['name'];} ?>" required>
...
<div id="print">
    ...
    <br> <br>
    <h2 class = "text-center">POSITION'S BREAKDOWN</h2>
        <div class="table-responsive">
            <table id = "table" class = "table table-hover table-bordered table-striped m-auto text-dark">
                ...
                if(isset($_GET['name'])){
                    $name = $_GET['name'];
                    $result = "SELECT * FROM srcms_tbl_personnel WHERE CONCAT(position) LIKE '%$name%'";
