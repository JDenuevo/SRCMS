...
<title>Staff View Records | SR&CMS</title>
...
<br> <br>
  <section class = "pt-3">
    ...
    <a href="staff_report_rb.php" >
      <button class = "btn btn-primary text-right me-2" id = "btnseedelrec" type="button">
            ...
            <table id = "table" class = "table table-hover table-bordered table-striped m-auto text-dark">
                ...
                <tbody>
                    ...
                    <td class = "align-middle">
                        <a class = "text-decoration-none" href="staff_edit_personnel.php?per_id=<?php echo $row['per_id'] ?>">
                        <span class="btn btn-primary my-1 w-100" aria-hidden = "true"><img class = "img-fluid" id = "tblicons" src = "photos/updrec.png"> Update</span>
                        </a>
                        <a class = "text-decoration-none" href="staff_print_individual_report.php?per_id=<?php echo $row['per_id']?>">
                        <span class="btn btn-secondary my-1 w-100"><img class = "img-fluid" id = "tblicons" src = "photos/printrec.png"> Print Record</span>
                        </a>
                        <a class = "text-decoration-none" href="staff_print_coe.php?per_id=<?php echo $row['per_id']?>">
