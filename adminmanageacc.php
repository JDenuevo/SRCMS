...
<title>Admin Accounts List | SR&CMS</title>
  ...
  <section class = "pt-3">
    ...
    <a href="signup.php">
      <button class = "btn btn-success text-right me-2" id = "btnaddrec" type="button">
        <img class = "img-fluid" id = "navicons" src = "photos/addacc.png">
        ADD ACCOUNT
      </button>
    </a> 
...
<section class = "pt-2">
    <h2 class = "text-center fw-bold">ACCOUNTS LIST</h2>
          ...
          <table id = "table" class = "table table-hover table-bordered table-striped table-fixed m-auto text-dark">
              ...
              <tbody>
                ...
                <td class = "align-middle"> 
                  <a class = "text-decoration-none" href="adminmanageacc_edit.php?id=<?php echo $row['id'] ?>">
                    <span class="btn btn-primary my-1 w-100" aria-hidden = "true"><img class = "img-fluid" id = "tblicons" src = "photos/updacc.png"> Update</span>
                  </a>
                  <a class = "text-decoration-none" href="adminmanageacc_delete.php?id=<?php echo $row['id'] ?>" onclick="return checkdelete('Are you sure you want to delete this RECORD?')">
                    <span class="btn btn-danger my-1 w-100" aria-hidden = "true"><img class = "img-fluid" id = "tblicons" src = "photos/delacc.png"> Delete</span>  
                  </a>
