...
<title>Staff Deleted Records | SR&CMS</title>
                ...
                <thead>
                  ...
                  <tbody>
                      ...
                      <td class = "align-middle">
                        <a class = "text-decoration-none" href="staff_print_individual_report_rb.php?per_id=<?php echo $row['per_id']?>">
                        <span class="btn btn-secondary my-1 w-100"><img class = "img-fluid" id = "tblicons" src = "photos/printrec.png"> Print Record</span>
                        </a>
                        <a class = "text-decoration-none" href="staff_print_coe_rb.php?per_id=<?php echo $row['per_id']?>">
